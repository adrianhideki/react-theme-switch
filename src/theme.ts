import { colors, type Theme } from "theme-token-manager/theme";
  ...
  palette: {
    dark: {
      surface: {
        ...
        "secondary-defaultSubtle": { color: "secondary", scale: 600 },
        ...
        default: { color: "primary", scale: 1000 },
        page: { color: "primary", scale: 1000 },
        pageAlternative: { color: "primary", scale: 900 },
