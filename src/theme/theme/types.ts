...
export type DashToObj<
  T,
  K extends string = ThemePaletteBorderThemes,
> = K extends `${infer Outer}-${infer Rest}`
  ? { [O in Outer]: DashToObj<T, Rest> }
  : { [O in K]: T };

export const colorValuesThemes = [
  "primary",
  "secondary",
  "accent",
  "success",
...
export type ColorValues = (typeof colorValuesThemes)[number];

export type FoundationValues = "foundation.white" | "foundation.black";

export const fontValuesThemes = [
  "label",
  "labelLong",
  "h1",
  "h2",
...
export type FontValues = (typeof fontValuesThemes)[number];
...
export const themePaletteSurfaceThemes = [
  "primary-default",
...
export type ThemePaletteSurfaceThemes =
  (typeof themePaletteSurfaceThemes)[number];
...
export const themePaletteTextThemes = [
  "primary-onColor",
...
export type ThemePaletteTextThemes = (typeof themePaletteTextThemes)[number];

export type ThemePaletteText<Value> = Record<ThemePaletteTextThemes, Value>;

export const themePaletteIconThemes = [
  "primary-onColor",
  "primary-onColorHover",
  "primary-onColorSubtle",
  "primary-onColorSubtleHover",
...
export type ThemePaletteIconThemes = (typeof themePaletteIconThemes)[number];

export type ThemePaletteIcon<Value> = Record<ThemePaletteIconThemes, Value>;

export const themePaletteBorderThemes = [
  "primary-default",
  "primary-defaultHover",
  "primary-defaultSubtle",
  "primary-defaultSubtleHover",
...
export type ThemePaletteBorderThemes =
  (typeof themePaletteBorderThemes)[number];

export type ThemePaletteBorder<Value> = Record<ThemePaletteBorderThemes, Value>;
